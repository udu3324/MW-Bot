...
public class Data {
    ...
    public static final String abyssSoonIcon = "/abyss_soon_upscale.png";
    public static final String abyssStartIcon = "/abyss_Start.gif";
    public static final String abyssEndIcon = "/abyss_End.gif";
    ...
    public static final String logFile = "C:\\Users\\build\\Desktop\\MW-Bot\\latest.log";
    ...
    public static final String channelFoxHunt = "863979026803458080";
    public static final String channelBait = "863979084080873492";
    public static final String channelCastle = "863979109898256395";
    public static final String channelChatOrBotLog = "863979232699219978";
    public static final String channelRawAlerts = "863993133422084107";
