...
public class Data {
    ...
    public static String abyssSoonIcon = "/abyss_soon_upscale.png"; //deprecate soon
    public static String abyssStartIcon = "/abyss_Start.gif"; //deprecate soon
    public static String abyssEndIcon = "/abyss_End.gif"; //deprecate soon
